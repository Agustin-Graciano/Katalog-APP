<template>
  <div class="document-editor">
    <div class="document-editor__toolbar">
      ...
      <span class="document-editor__page-indicator">{{currentPageIndicator}}</span>
    </div>
    <div class="document-editor__editable-container">
      <div class="document-editor__editable">
        <TextEditor :categories="categoriesData" @categories-updated="updateCategories" @text-editor-insert-block="addBlock" />
